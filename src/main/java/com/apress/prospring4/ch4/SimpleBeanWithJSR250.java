...
public class SimpleBeanWithJSR250 {
	...
	if (age == Integer.MIN_VALUE) {
	    throw new IllegalArgumentException(
		    "You must set the age property of any beans of type " + SimpleBeanWithJSR250.class);
	}
    }
	...
	ctx.load("classpath:META-INF/spring/app-context-postConstructAnnotation.xml");
	ctx.refresh();
